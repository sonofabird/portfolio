    ...
    <ThemeProvider theme={theme}>
      ...
      <Box paddingX="10%" paddingY="10%">
        ...
        <Typography variant="b1" align="left">
          ...
          goal is to make Mentra feel like a true mentor that is invested in the
          user’s ideas.
        </Typography>
        <Typography variant="b1" align="left">
          In this example, the AI just jumps from point to point without showing
          any real interest in the idea [1]. No questions or suggestions are
          made in direct relation to what the user proposed. Furthermore, Mentra
          should guide the user more without them having to ask directly for
          help too much [2].
        </Typography>
        <Image
